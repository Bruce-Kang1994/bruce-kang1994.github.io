...
**和我们的框架关系**：这对应 [产品增长通用框架](/lab/posts/growth-dimension-framework/) 8 维度中的"网络效应"维度，以及 [美团拆解](/lab/posts/meituan-growth-levers/) 中"业务协同"的概念。
...
> 更完整的护城河理论，见 [Seven Powers：AI 时代的 7 种竞争壁垒](/lab/posts/seven-powers-ai-moats/)。
...
| 本文观点 | 深入阅读 |
|---------|---------|
| 自然频率定律 | [低频产品留存策略](/lab/posts/low-frequency-retention/) + [Reforge 增长体系](/lab/posts/reforge-growth-frameworks/) |
| 护城河叠加 | [Seven Powers 框架](/lab/posts/seven-powers-ai-moats/) |
| PLG + Onboarding | [ElevenLabs 访谈精华](/lab/posts/elevenlabs-interview-highlights/)（Luke 的团队建设观点） |
| 单人→多人 | [产品增长通用框架](/lab/posts/growth-dimension-framework/)（网络效应维度） |
